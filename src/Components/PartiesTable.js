  ...
  getInfo(item) {
    return (
      <span>
        ...
        {!!item.addressbook["first-name"]
          ? item.addressbook["first-name"]["#text"]
          : ""}
        {!!item.addressbook["last-name"]
          ? ' '+ item.addressbook["last-name"]["#text"]
          : ""}
        {!!item.addressbook["address"]
          ? ` (${!!item.addressbook["address"]["city"]
              ? item.addressbook["address"]["city"]["#text"]
              : ""} ${!!item.addressbook["address"]["country"]
              ? item.addressbook["address"]["country"]["#text"]
              : ""})`
          : ""}
        <br />
      </span>
