      ...
      <Segment>
        <Grid stackable columns={2}>
          <Grid.Row>
            <Grid.Column textAlign={"left"} width={8}>
              ...
              <HeaderWithType
                type={"Title"}
                size={"h2"}
                content={this.patentData["-title"]}
              />
              <Divider />
              <Header as="h2">Abstract</Header>
              <p>
                {this.patentData.abstract.p["#text"]}
              </p>
            </Grid.Column>
            <Grid.Column textAlign={"right"} width={8}>
              <HeaderWithType
                type={"Patent Nº"}
                size={"h2"}
                content={this.patentData["-ucid"]}
              />
              <HeaderWithType
                type={"Doc Nº"}
                size={"h5"}
                content={this.patentData["-doc-number"]}
              />
              <HeaderWithType
                type={"Date"}
                size={"h5"}
          ...
          <Grid.Row>
            ...
            <Grid.Column textAlign={"left"} width={8}>
              <PartiesTable
                parties={this.patentData["bibliographic-data"]["parties"]}
              />
            </Grid.Column>
          </Grid.Row>
        </Grid>
